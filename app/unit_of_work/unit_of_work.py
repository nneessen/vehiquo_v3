...
from app.repositories.stores import store_repository, store_repository_base
from app.repositories.units import unit_repository, unit_repository_base
from app.repositories.users import user_repository, user_repository_base
from app.repositories.vehicles import (vehicle_repository,
                                       vehicle_repository_base)
